...
def main():
    ...
    path_1_start = [
        get_waypoint_msg(1000, 1.7, 9.0, -1.86, 0.0, True),
        get_waypoint_msg(2000, 1.7, 9.0, -16.890, 0.0, True),
    ]
    commands.append((1, "Step 1: 1번 위치 이동 ( 비전 방 )", create_path_command_with_ids(path_1_start), pub_live_path))
    ...
    # 3단계
    commands.append((3, "Step 3: 1번 위치 1단 로딩 - 비전방 1단", 
                    get_forklift_msg(9.0, -16.890, 180.0, 12.987, -16.890, 180.0, 1, 1), 
                     pub_fork, True, True, True))

    # 4단계
    path_1_start = [
        get_waypoint_msg(1000, 1.7, 9.0, -16.890, 0.0, True),
        get_waypoint_msg(2000, 1.7, 9.0, -4.370, 0.0, True),
    ]
    commands.append((4, "Step 4: 2번 위치 이동 ( 랙 2번 )", create_path_command_with_ids(path_1_start), pub_live_path, True, False, True))
    ...
    # 7단계
    commands.append((7, "Step 7: 렉 2번 위치 1단 언로딩 - 랙방", 
                     get_forklift_msg(9.0, -4.370, 180.0, 13.0250, -4.370, 180.0, -1, 1), 
                     pub_fork, True, True, True))

    # 8단계
    path_1_start = [
        get_waypoint_msg(1000, 1.7, 9.0, -4.370, 0.0, True),
        get_waypoint_msg(1000, 1.7, 9.0, 1.70, 0.0, True),
    ]
    commands.append((8, "Step 8: 3번 위치 이동 ( 윙바디 4번 )", create_path_command_with_ids(path_1_start), pub_live_path, True, False, True))
    ...
    # 10단계
    commands.append((10, "Step 10: 3번 위치 1단 로딩 - 윙바디 4번", 
                     get_forklift_msg(9.0, 1.70, 0.0, 4.46, 1.7, 0.0, 1, 2), 
                     pub_fork, True, True, True))


    # 11단계
    path_1_start = [
        get_waypoint_msg(1000, 1.7, 9.0, 1.7, 0.0, True),
        get_waypoint_msg(1000, 1.0, 9.0, 6.1, 0.0, True)
    ]
    commands.append((11, "Step 11: 4번 위치 이동 ( 윙바디 2번 )", create_path_command_with_ids(path_1_start), pub_live_path, True, False, True))
    ...
    # 14단계
    commands.append((14, "Step 14: 1단 언로딩 - 윙바디 상차 _ 2번", 
                     get_forklift_msg(9.0, 6.1, 0.0, 4.35, 6.1, 0.0, 3, 2), 
                     pub_fork, True, True, True))      


    # 15단계
    path_1_start = [
        get_waypoint_msg(1000, 1.7, 9.0, 6.1, 0.0, True),
        get_waypoint_msg(1000, 1.7, 9.0, 3.9, 0.0, True),
    ]
    commands.append((15, "Step 15: 5번 위치 이동 ( 윙바디 3번 )", create_path_command_with_ids(path_1_start), pub_live_path, True, False, True))
    ...
    # 17단계
    commands.append((17, "Step 17: 3번 위치 1단 로딩 - 윙바디 3번", 
                     get_forklift_msg(9.0, 3.9, 0.0, 4.35, 3.9, 0.0, 1, 2), 
                     pub_fork, True, True, True))


    # 18단계
    path_1_start = [
        get_waypoint_msg(1000, 1.0, 9.0, 3.9, 0.0, True),
        get_waypoint_msg(1000, 1.7, 9.0, 8.3, 0.0, True),

    ]
    commands.append((18, "Step 18: 6번 위치 이동 ( 윙바디 1번 ) ", create_path_command_with_ids(path_1_start), pub_live_path, True, False, True))
    ...
    # 21단계
    commands.append((21, "Step 21: 1단 언로딩 - 윙바디 상차 _ 3번", 
                     get_forklift_msg(9.0, 8.3, 0.0, 4.35, 8.3, 0.0, 3, 2), 
                     pub_fork, True, True, True))  


    path_1_start = [
        get_waypoint_msg(1000, 1.7, 9.0, 8.3, 0.0, True),
        get_waypoint_msg(2000, 1.7, 9.0, -9.593, 0.0, True),
    ]
    commands.append((29, "Step 29: 시작 위치 이동", create_path_command_with_ids(path_1_start), pub_live_path, True, False, True))
