...
#ifndef MPC_SD_SOLVER_HPP_
#define MPC_SD_SOLVER_HPP_
...
public:
  ...
  explicit MpcSdSolver(int n_step_size, int n_state_size=4);
  virtual ~MpcSdSolver() = default;
