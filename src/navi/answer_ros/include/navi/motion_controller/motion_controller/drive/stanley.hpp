...
class Stanley : public MotionController
{
public:
  Stanley();
...
private:
  ...
  virtual double CalcSTCurv(const Path& path, const Pose& o_robot_state, int n_closest_idx, const ControlInfo_t& st_control_info) const;
