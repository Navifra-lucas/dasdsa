...
class HybridAstar : public SearchPlanner
{
public:
...
protected:
  ...
  bool InitializeStartNode(const Pose& o_start_pose, bool b_backward,
    HNode*& origin_start_node,
    std::priority_queue<HNode*, std::vector<HNode*>, CmpCost>& visit_lists);
  bool InitializeGoalNode(const Pose& o_goal_pose, bool b_backward,
    HNode*& origin_goal_node, HNode*& goal_node);

  bool IsNearGoalNode(const HNode* curr_node, const HNode* goal_node) const;
