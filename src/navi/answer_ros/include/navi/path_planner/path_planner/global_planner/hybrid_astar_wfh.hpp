...
#ifndef GLOBAL_PLANNER_HYBRID_ASTAR_WFH_HPP_
#define GLOBAL_PLANNER_HYBRID_ASTAR_WFH_HPP_

#include "path_planner/global_planner/hybrid_astar.hpp"

namespace NVFR {

namespace GlobalPlanner {

class HybridAstarWFH : public HybridAstar
{
public:
  explicit HybridAstarWFH(
    ...
    int n_theta_size = 36);
  virtual ~HybridAstarWFH() = default;
