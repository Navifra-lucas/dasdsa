/**
 * @class map limits
 * @brief  map information for each localmap.
...
public:
    ...
    // explicit MapLimits(const MapLimits& map_limits)
    ...
    CellLimits& mutable_cell_limits() { return cell_limits_; }
    ...
    Eigen::Array2i GetCellIndex(const Eigen::Vector2f& point) const
    {
        ...
        return Eigen::Array2i(
            std::lround((max_.y() - point.y()) / resolution_ - 0.5), std::lround((max_.x() - point.x()) / resolution_ - 0.5));
    }
