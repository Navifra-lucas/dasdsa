...
/*!
    ...
    \li http://www.boost.org/doc/libs/1_42_0/boost/detail/endian.h
*/
...
*/
    ...
    #define CEREAL_RAPIDJSON_GETPOINTER(type, p) \
        (reinterpret_cast<type*>(                \
            reinterpret_cast<uintptr_t>(p) & static_cast<uintptr_t>(CEREAL_RAPIDJSON_UINT64_C2(0x0000FFFF, 0xFFFFFFFF))))
#else
...
*/
#if defined(CEREAL_RAPIDJSON_SSE2) || defined(CEREAL_RAPIDJSON_SSE42) || defined(CEREAL_RAPIDJSON_NEON) || \
...
CEREAL_RAPIDJSON_NAMESPACE_END
    ...
    #define CEREAL_RAPIDJSON_STATIC_ASSERT(x)                                                                                           \
        typedef ::CEREAL_RAPIDJSON_NAMESPACE::StaticAssertTest<sizeof(::CEREAL_RAPIDJSON_NAMESPACE::STATIC_ASSERTION_FAILURE<bool(x)>)> \
...
// CEREAL_RAPIDJSON_DIAG_PUSH/POP, CEREAL_RAPIDJSON_DIAG_OFF
    ...
    #define CEREAL_RAPIDJSON_DIAG_OFF(x) CEREAL_RAPIDJSON_DIAG_PRAGMA(ignored CEREAL_RAPIDJSON_STRINGIFY(CEREAL_RAPIDJSON_JOIN(-W, x)))
...
// C++11 features
        ...
        #endif
    #elif (                                                                                                    \
        defined(CEREAL_RAPIDJSON_GNUC) && (CEREAL_RAPIDJSON_GNUC >= CEREAL_RAPIDJSON_VERSION_CODE(4, 3, 0)) && \
