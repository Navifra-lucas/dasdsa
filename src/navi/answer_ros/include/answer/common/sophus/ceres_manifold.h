...
#include <sophus/ceres_typetraits.h>
...
public:
    ...
    bool PlusJacobian(double const* T_raw, double* jacobian_raw) const override
    {
        ...
        Eigen::Map<Eigen::Matrix<double, num_parameters, DoF, DoF == 1 ? Eigen::ColMajor : Eigen::RowMajor>> jacobian(jacobian_raw);
    ...
    bool MinusJacobian(double const* x_raw, double* jacobian_raw) const override
    {
        ...
        Eigen::Map<Eigen::Matrix<double, DoF, num_parameters, Eigen::RowMajor>> jacobian(jacobian_raw);
