...
public:
    ...
    SOPHUS_FUNC Transformation matrix() const
    {
        ...
        homogeneous_matrix.row(2) = Matrix<Scalar, 1, 3>(Scalar(0), Scalar(0), Scalar(1));
    ...
    SOPHUS_FUNC void setRotationMatrix(Matrix<Scalar, 2, 2> const& R)
    {
        ...
        typename SO2Type::ComplexTemporaryType const complex(Scalar(0.5) * (R(0, 0) + R(1, 1)), Scalar(0.5) * (R(1, 0) - R(0, 1)));
    ...
    ///
    SOPHUS_FUNC
    typename Eigen::internal::traits<Derived>::SO2Type::ComplexT const& unit_complex() const { return so2().unit_complex(); }
};
...
public:
    ...
    SOPHUS_FUNC static Sophus::Matrix<Scalar, 2, DoF> Dx_exp_x_times_point_at_0(Point const& point)
    {
        ...
        J << Sophus::Matrix2<Scalar>::Identity(), Sophus::SO2<Scalar>::Dx_exp_x_times_point_at_0(point);
        return J;
    }
    ...
    SOPHUS_FUNC static Tangent lieBracket(Tangent const& a, Tangent const& b)
    {
        ...
        return Tangent(-theta1 * upsilon2[1] + theta2 * upsilon1[1], theta1 * upsilon2[0] - theta2 * upsilon1[0], Scalar(0));
    }
...
{
    static_assert(std::is_standard_layout<SE2>::value, "Assume standard layout for the use of offset of check below.");
    static_assert(
        offsetof(SE2, so2_) + sizeof(Scalar) * SO2<Scalar>::num_parameters == offsetof(SE2, translation_),
