    ...
    do {                                                                                                                               \
        if (left != right) {                                                                                                           \
            std::string msg = SOPHUS_FMT_STR(                                                                                          \
                "{} (={}) is not equal to {} (={})\n", SOPHUS_STRINGIFY(left), Sophus::details::pretty(left), SOPHUS_STRINGIFY(right), \
    ...
    do {                                                                                                                         \
        ...
        if (!(nrm < (thr))) {                                                                                                    \
            std::string msg = SOPHUS_FMT_STR(                                                                                    \
                ...
                SOPHUS_STRINGIFY(right), Sophus::details::pretty(right), SOPHUS_STRINGIFY(thr), Sophus::details::pretty(thr),    \
    ...
    do {                                                                                                                        \
        ...
        if (nrm < (thr)) {                                                                                                      \
            std::string msg = SOPHUS_FMT_STR(                                                                                   \
                ...
                "is {}\n",                                                                                                      \
                SOPHUS_STRINGIFY(left), Sophus::details::pretty(left), SOPHUS_STRINGIFY(right), Sophus::details::pretty(right), \
                SOPHUS_STRINGIFY(thr), Sophus::details::pretty(thr), Sophus::details::pretty(nrm));                             \
            msg += SOPHUS_FMT_STR(descr, ##__VA_ARGS__);                                                                        \
            Sophus::details::testFailed(passed, SOPHUS_FUNCTION, __FILE__, __LINE__, msg);                                      \
        }                                                                                                                       \
    } while (false)
