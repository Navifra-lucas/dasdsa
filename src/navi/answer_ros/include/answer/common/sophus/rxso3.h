...
template <class Scalar_, int Options_>
struct traits<Map<Sophus::RxSO3<Scalar_> const, Options_>> : traits<Sophus::RxSO3<Scalar_, Options_> const> {
    static constexpr int Options = Options_;
    using Scalar = Scalar_;
...
public:
    ...
    SOPHUS_FUNC void setQuaternion(Eigen::Quaternion<Scalar> const& quat)
    {
        ...
        SOPHUS_ENSURE(
            quat.squaredNorm() < Scalar(1.) / (Constants<Scalar>::epsilon() * Constants<Scalar>::epsilon()),
    ...
    SOPHUS_FUNC void setScaledRotationMatrix(Transformation const& sR)
    {
        ...
        SOPHUS_ENSURE(
            squared_scale >= Constants<Scalar>::epsilon() * Constants<Scalar>::epsilon(), "Scale factor must be greater-equal epsilon.");
        SOPHUS_ENSURE(
            squared_scale < Scalar(1.) / (Constants<Scalar>::epsilon() * Constants<Scalar>::epsilon()),
            "Inverse scale factor must be greater-equal epsilon.");
...
public:
        ...
        : quaternion_(R)
    {
        ...
        SOPHUS_ENSURE(scale < Scalar(1.) / Constants<Scalar>::epsilon(), "Inverse scale factor must be greater-equal epsilon.");
        using std::sqrt;
        ...
        : quaternion_(quat)
    {
        ...
        SOPHUS_ENSURE(quaternion_.squaredNorm() >= Constants<Scalar>::epsilon(), "Scale factor must be greater-equal epsilon.");
        SOPHUS_ENSURE(
            quat.squaredNorm() < Scalar(1.) / Constants<Scalar>::epsilon(), "Inverse scale factor must be greater-equal epsilon.");
    }
