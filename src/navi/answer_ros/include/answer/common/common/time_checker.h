...
public:
    ...
    void MeasureStart();
    void MeasureEnd(const string message = std::string(), const int limitation = INT_MAX);
    void MeasureEndMicro(const string message = std::string(), const int limitation = INT_MAX);
