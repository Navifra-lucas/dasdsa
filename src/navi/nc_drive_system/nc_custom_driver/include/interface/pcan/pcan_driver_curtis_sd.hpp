...
#ifndef NAVIFRA_PCAN_DRIVER_CURTIS_SD_HPP_
#define NAVIFRA_PCAN_DRIVER_CURTIS_SD_HPP_
...
union PCAN_CURTIS_SD_WRITE_1  // 송신부
{
    struct {
...
union PCAN_CURTIS_SD_WRITE_2  // 송신부
{
    struct {
...
union PCAN_CURTIS_SD_WRITE_3  // 송신부
{
    struct {
...
union PCAN_CURTIS_SD_SDO_WRITE  // 송신부
{
    struct {
...
union PCAN_CURTIS_SD_READ_1  // 주행tpdo수신부
{
    struct {
...
union PCAN_CURTIS_SD_READ_2  // 조향tpdo수신부
{
    struct {
...
union PCAN_CURTIS_SD_READ_3  // 절댓값엔코더수신부
{
    struct {
...
union PCAN_CURTIS_SD_SDO_READ  // 수신부
{
    struct {
...
class Pcan_driver_curtis_sd : public Pcan_driver {
public:
    Pcan_driver_curtis_sd()
        : running_(true)
        , workerThread_(&Pcan_driver_curtis_sd::watchdog, this){};
    ~Pcan_driver_curtis_sd()
    {
    ...
    PCAN_CURTIS_SD_SDO_READ SendSDOMsg(int node_id, int command, int index, int sub_index, int data);
