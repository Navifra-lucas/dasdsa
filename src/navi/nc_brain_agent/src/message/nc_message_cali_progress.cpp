...
NcMessageCaliProgress::NcMessageCaliProgress()
{
}

void NcMessageCaliProgress::handleMessage(Poco::JSON::Object::Ptr message)
{
    ...
    MessageBroker::instance().publish(
        NcBrainMessage::MESSAGE_ROBOT_STATUS_CALIBRATION + InMemoryRepository::instance().get<RobotStatus>(RobotStatus::KEY)->getID(),
        oss.str());
