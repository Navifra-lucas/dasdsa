...
NcMessageGlobalPath::NcMessageGlobalPath()
{
}

void NcMessageGlobalPath::handleMessage(Poco::JSON::Object::Ptr message)
{
    ...
    MessageBroker::instance().publish(
        NcBrainMessage::MESSAGE_ROBOT_STATUS_PATH + InMemoryRepository::instance().get<RobotStatus>(RobotStatus::KEY)->getID(), oss.str());
