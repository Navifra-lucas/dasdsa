...
NcMessageHardwareInfo::NcMessageHardwareInfo()
{
}

void NcMessageHardwareInfo::handleMessage(Poco::JSON::Object::Ptr message)
{
    ...
    MessageBroker::instance().publish(
        NcBrainMessage::MESSAGE_ROBOT_STATUS_HARDWARE_INFO + InMemoryRepository::instance().get<RobotStatus>(RobotStatus::KEY)->getID(),
        oss.str());
