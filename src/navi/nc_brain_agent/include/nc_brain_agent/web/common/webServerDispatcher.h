#ifndef NAVICPP_WEBSERVER_DISPATCHER
#define NAVICPP_WEBSERVER_DISPATCHER
...
protected:
    ...
    std::string formatMessage(
        const std::string& messageId, const std::string& arg1 = std::string(), const std::string& arg2 = std::string());
...
#endif  // SEMITS_SMM_WEBSERVER_DISPATCHER
