// void NcActionTask::saveTask(std::string task_json)
// {
//     const char* home_dir = getenv("HOME");
//     if (home_dir == nullptr) {
//         std::cerr << "Error: HOME environment variable not set." << std::endl;
//     }
//     std::string base_path = std::string(home_dir) + "/.ros/wia_task/";
//     std::string s_mission_path = base_path + "mission.txt";

//     mkdir((std::string(home_dir) + "/.ros").c_str(), 0775);
...
//         std::cerr << "오류: 파일을 쓰기 모드로 열 수 없습니다: " << s_mission_path << std::endl;
//         return;
//     }
...
// std::pair<std::string, int> getMission()
// {
//     const char* home_dir = getenv("HOME");
//     if (home_dir == nullptr) {
...
// {
//     if (msg->data) {  // 포인터가 유효하고, 그 값이 true이면
//         // mission.txt에 미션이 있고, 인덱스가 남아 있는지 확인
//         if (checkMission()) {
//             startMission();
//         }
//         else {
//             NLOG(info) << "실행할 미션이 없습니다.";
//         }
//     }
// }
