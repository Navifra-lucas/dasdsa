...
Set ```send_device_ctrl_state_ros```  = true, customize topics and publish device status through ROS topics,
                                             See details (../intro/03_device_ctrl_intro_CN.md).
...
lidar:
  - driver:
      ...
      angle_path_ver: ".../src/vanjee_lidar_sdk/param/Vanjee_720_16_VA.csv"      # Path to the vertical angle configuration file
      angle_path_hor: ".../src/vanjee_lidar_sdk/param/Vanjee_720_16_hA.csv"      # Path to the horizontal angle configuration file
      imu_param_path: ".../src/vanjee_lidar_sdk/param/vanjee_720_imu_param.csv"  # Path to the IMU parameters configuration file
...
设置 ```pcap_path```            = ".../720_16.pcap"(absolute path), read the pcap file from this path.
