...
struct LaneAvoidance_t {
    ...
    int n_left_num;
    int n_right_num;
    float f_search_step_size_m;
    int n_search_min_step;
    int n_search_max_step;
};

struct MPCParameters_t {
    // normal
    float f_motion_steps;
    float f_motion_ref_cte;
    float f_motion_vel;
    float f_motion_ref_etheta;
    float f_motion_w_cte;
    float f_motion_w_etheta;
    float f_motion_w_vel;
    float f_motion_w_angvel;
    float f_motion_w_angvel_d;
    float f_motion_w_accel;
    float f_motion_w_accel_d;
    float f_motion_throttle;
    float f_motion_bound_value;
    float f_motion_front_path_idx;
    float f_motion_back_path_idx;
    float f_motion_curve_front_path_idx;
    float f_motion_curve_back_path_idx;

    float f_motion_start_dist;
    float f_motion_start_speed;
    float f_motion_start_min_speed;
    float f_motion_start_duration;
    bool b_start_control_dist_flag;

    // low speed
    float f_motion_low_speed_std;
    float f_motion_low_speed_w_cte;
    float f_motion_low_speed_w_etheta;
    float f_motion_low_speed_w_angvel;

    float f_motion_high_speed_std;
    float f_motion_high_speed_w_angvel;
    float f_motion_high_w_accel;
    float f_motion_high_w_accel_d;
    float f_motion_high_throttle;

    float f_motion_high_curve_speed_std;
    float f_motion_high_curve_speed_w_angvel;
    float f_motion_curve_w_accel;
    float f_motion_curve_w_accel_d;
    float f_motion_curve_throttle;
    float f_motion_curve_w_angvel;
    float f_motion_curve_w_angvel_d;

    float f_motion_arrive_p_gain;
    float f_motion_arrive_d_gain;

    int n_arc_determined_distance_index;
    MPCParameters_t()
    {
        f_motion_steps = 40.0;
...
struct Parameters_t {
    ...
    float f_restart_obs_check_m;

    bool b_use_camera_predict_mode_flag = false;
    float f_camera_collision_predict_sec;
    ...
    float f_spinturn_add_radius = 0.0;

    bool b_camera_obs_clear;
    bool b_set_area_ratio;
    bool b_use_dynamic_camera;
    float f_set_area_ratio_time_sec;
    float f_camera_suspendmission_dist_m;
    float f_camera_obs_clear_time_sec;
    float f_docking_camera_check_sec;
    float f_camera_sto_off_m;
    float f_camera_path_check_m;
    float f_camera_path_check_step;
    float f_camera_path_check_side_margin;

    bool b_use_detection_mode_flag = true;
    bool b_use_predict_mode_flag = true;
    bool b_use_side_check_flag = true;
    int n_collision_estop_period_ms;
    int n_unlock_suspending_duration_ms;
    ...
    bool b_use_obs_alarm_separate;

    float f_collision_predict_sec;

    float f_collision_extension_x_m;
    float f_collision_extension_y_m;
    float f_collision_extension_max_vel_ms;
    float f_collision_extension_min_vel_ms;

    // RS path planning
    float f_goal_arrive_turning_radius_m;
    float f_goal_arrive_path_step_size_m;
    float f_goal_arrive_straight_line_ratio;

    std::map<std::string, Polygon> map_polygon_robot_collision_;

    int n_goal_arrive_start_align_index;
    bool b_allways_align_flag;
    // Motion Constraints End
    float f_motion_control_period = 0.1;
    float f_vel_percent_enable_standard_ms;
    ...
    bool b_avoid_permission;
    float f_min_dist_for_forward_path_m;

    // avoid
    int n_detection_period_ms;
    int n_avoidance_period_ms;
    float f_force_comeback_start_dist_m;
    float f_force_comeback_target_dist_m;
    float f_force_comeback_in_curve_added_start_dist_m;
    float f_dubins_normal_max_curve_radius_m;
    float f_dubins_normal_min_curve_radius_m;
    float f_dubins_normal_curve_interval_m;
    float f_dubins_force_max_curve_radius_m;
    float f_dubins_force_min_curve_radius_m;
    float f_dubins_force_curve_interval_m;
    float f_polynominal_max_curvature_m;
    float f_avoid_imposible_sec_s;
    ...
    // docking
    float f_double_check_dist_m;
    float f_straight_path_dist_m;
