...
#ifndef NAVIFRA_NC_LCCS_LIDAR_MERGER__H
    #define NAVIFRA_NC_LCCS_LIDAR_MERGER_H
...
private:
    ...
    vector<string> vec_input_topics2;
    ...
    float f_x_fork_flat_front_m_;
    float f_x_fork_flat_back_m_;
    float f_y_fork_flat_left_m_;
    float f_y_fork_flat_right_m_;
...
public:
    LccsLidarMergerFilter(ros::NodeHandle& nh, ros::NodeHandle& nhp);
    virtual ~LccsLidarMergerFilter();
...
private:
    ...
    void VanjeeCallback(const sensor_msgs::PointCloud2::ConstPtr& msg);
