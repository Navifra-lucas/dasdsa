...
public:
    ...
    bool CheckAlarmNode();
    void SetActionName(const std::string& str_action_name) {
        str_action_name_ = str_action_name;
    }
    std::string GetActionName() const { return str_action_name_; }
